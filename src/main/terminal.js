...
class MetaShell extends base {
    ...
    setPath(base) {
        function defaultPath() {
            ...
            // return `${process.env.HOME}/code/atom-python-run/main.py`; // User/chenkai/
            return '/Users/chenkai/code/atom-python-run/main.py';
        }
        this.set(this.get(), {
...
// module.exports = Base
// module.exports = LinuxSessionWrapper
// module.exports = MetaShell;
